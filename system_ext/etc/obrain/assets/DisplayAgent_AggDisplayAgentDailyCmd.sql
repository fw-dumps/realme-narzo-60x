...
TOTAL_EG_RAW_JSON_TB as (
	select '{{"s_id":' || screen_id || ',"mode":' || '"' || ground_mode || screen_mode || thermal_mode || power_mode || '"' ||
	',"fps":' || FPS || ',"rfps":' || renderFps ||',"bri":[' || group_concat(brightness) ||
	'],"eg":[' || group_concat(total_eg) || '],"du":[' || group_concat(total_du) || ']}}' as energy
...
MODE_TOTAL_APP_JSON_TB as (
	select '{{"app":"' || obfuscate(app) || '","mode":' || '"' || ground_mode || screen_mode || thermal_mode || power_mode || '"' ||
	',"fps":' || FPS || ',"rfps":' || renderFps ||',"bri":[' || group_concat(brightness) ||
	'],"eg":[' || group_concat(total_eg) || '],"du":[' || group_concat(total_du) || ']}}' as by_mode
...
APP_TOP_NORMAL_JSON_TB as (
	select '{{"app":"' || obfuscate(app) || '","act":"' || activity || '","s_id":' || screen_id ||
...
APP_TOP_SPLIT_JSON_TB as (
	select '{{"app":"' || obfuscate(app) || '","act":"' || activity || '","app_s":"' || obfuscate(app_secondary) ||
	'","act_s":"' || activity_secondary || '","s_id":' || screen_id ||
	',"mode":' || '"' || ground_mode || screen_mode || thermal_mode || power_mode || '"' ||
	',"fps":' || FPS || ',"rfps":' || renderFps ||',"bri":[' || group_concat(brightness) ||
	'],"eg":[' || group_concat(total_eg) || '],"du":[' || group_concat(total_du) || ']}}' as by_mode
...
APP_TOP_PARALLEL_JSON_TB as (
	select '{{"app":"' || obfuscate(app) || '","act":"' || activity || '","act_s":"' || activity_secondary || '","s_id":' || screen_id ||
	',"mode":' || '"' || ground_mode || screen_mode || thermal_mode || power_mode || '"' ||
	',"fps":' || FPS || ',"rfps":' || renderFps ||',"bri":[' || group_concat(brightness) ||
	'],"eg":[' || group_concat(total_eg) || '],"du":[' || group_concat(total_du) || ']}}' as by_mode
...
---- HIST_TB
HIST_JSON_TB as (
	select '{{{{"app":"' || obfuscate(app) || '", "rhist": "' || rhist || '","rsa": "' || rsample || '", "ghist": "' || ghist || '","gsa": "' || gsample || '", "bhist": "' || bhist || '", "bsa": "' || bsample || '"}}}}' as hist
...
---- BRIGHT_TB
BRIGHT_JSON_TB as (
	select '{{"s_id":' || screen_id || ',"du": ' || sum(total_du) || ',"bri":' || brightness || ', "bmod":' || brightmode || '}}' as by_bright
